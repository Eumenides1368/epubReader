...
<template>
  <div class="menu-bar">
    <transition name="slide-up">
      <div class="menu-wrapper" :class="{'hide-box-shadow': isSettingShow || !ifTitleAndMenu}"
      v-show="ifTitleAndMenu" >
        <div class="icon-wrapper">
          <span class="icon-list icon" @click="showSetting(3)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="icon-tuning icon" @click="showSetting(2)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="icon-brightness-up icon" @click="showSetting(1)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="icon-a icon" v-on:click="showSetting(0)">A</span>
        </div>
      </div>
    </transition>
    <transition name="slide-up">
        ...
        <div class="setting-font-size" v-if="showTag === 0">
            ...
            <div class="select">
              <div class="select-wrapper" v-for="(item, index) in fontSizeList"
                :key="index"
                v-on:click="setFontSize(item.fontSize)">
              <div class="line"></div>
